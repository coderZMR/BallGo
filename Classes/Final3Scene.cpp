...
void Final3::onEnterTransitionDidFinish()
{
...
bool Final3::init(){
	...
	auto backItem = MenuItemImage::create(
		"m2.png",
		"m02.png",
		CC_CALLBACK_1(Final3::backBtnMenu, this)
	...
	auto againItem = MenuItemImage::create(
		"m1.png",
		"m01.png",
		CC_CALLBACK_1(Final3::againBtnMenu, this)
...
// 返回至施文强界面
void Final3::backBtnMenu(Ref *ref){
...
void Final3::againBtnMenu(Ref *ref){
