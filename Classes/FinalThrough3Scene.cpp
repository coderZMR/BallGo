...
Scene * FinalThrough3::createScene(){

	auto scene = Scene::create();
	auto layer1 = LayerColor::create(Color4B(255, 245, 247, 255));
	scene->addChild(layer1);

	auto layer = FinalThrough3::create();
...
void FinalThrough3::onEnterTransitionDidFinish()
{
	SimpleAudioEngine::getInstance()->playEffect("Victory.mp3");
}

bool FinalThrough3::init(){
	...
	auto backItem = MenuItemImage::create(
		"m31.png",
		"m32.png",
		CC_CALLBACK_1(FinalThrough3::backBtnMenu, this)
	...
	auto againItem = MenuItemImage::create(
		"r31.png",
		"r32.png",
		CC_CALLBACK_1(FinalThrough3::againBtnMenu, this)
	...
	auto nextItem = MenuItemImage::create(
		"m33_n.png",
		"m331.png",
		CC_CALLBACK_1(FinalThrough3::nextBtnMenu, this)
...
// 返回至施文强界面
void FinalThrough3::backBtnMenu(Ref *ref){
...
void FinalThrough3::againBtnMenu(Ref *ref){
...
void FinalThrough3::nextBtnMenu(Ref *ref){
