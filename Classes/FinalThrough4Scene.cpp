...
Scene * FinalThrough4::createScene(){

	auto scene = Scene::create();
	auto layer1 = LayerColor::create(Color4B(255, 245, 247, 255));
	scene->addChild(layer1);

	auto layer = FinalThrough4::create();
...
void FinalThrough4::onEnterTransitionDidFinish()
{
	SimpleAudioEngine::getInstance()->playEffect("Victory.mp3");
}

bool FinalThrough4::init(){
	...
	auto backItem = MenuItemImage::create(
		"m41.png",
		"m42.png",
		CC_CALLBACK_1(FinalThrough4::backBtnMenu, this)
	...
	auto againItem = MenuItemImage::create(
		"r41.png",
		"r42.png",
		CC_CALLBACK_1(FinalThrough4::againBtnMenu, this)
	...
	auto nextItem = MenuItemImage::create(
		"m34_n.png",
		"m341.png",
		CC_CALLBACK_1(FinalThrough4::nextBtnMenu, this)
...
// 返回至施文强界面
void FinalThrough4::backBtnMenu(Ref *ref){
...
void FinalThrough4::againBtnMenu(Ref *ref){
...
void FinalThrough4::nextBtnMenu(Ref *ref){
