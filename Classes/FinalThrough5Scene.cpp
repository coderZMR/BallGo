...
Scene * FinalThrough5::createScene(){

	auto scene = Scene::create();
	auto layer1 = LayerColor::create(Color4B(255, 245, 247, 255));
	scene->addChild(layer1);

	auto layer = FinalThrough5::create();
...
void FinalThrough5::onEnterTransitionDidFinish()
{
	SimpleAudioEngine::getInstance()->playEffect("Victory.mp3");
}

bool FinalThrough5::init(){
	...
	auto backItem = MenuItemImage::create(
		"m51.png",
		"m52.png",
		CC_CALLBACK_1(FinalThrough5::backBtnMenu, this)
	...
	auto againItem = MenuItemImage::create(
		"r51.png",
		"r51.png",
		CC_CALLBACK_1(FinalThrough5::againBtnMenu, this)
	...
	auto nextItem = MenuItemImage::create(
		"m35_n.png",
		"m351.png",
		CC_CALLBACK_1(FinalThrough5::nextBtnMenu, this)
...
// 返回至施文强界面
void FinalThrough5::backBtnMenu(Ref *ref){
...
void FinalThrough5::againBtnMenu(Ref *ref){
...
void FinalThrough5::nextBtnMenu(Ref *ref){
	auto scene = PassAllGate::createScene();
	//转场到通关界面
