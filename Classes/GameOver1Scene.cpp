...
void GameOver1::onEnterTransitionDidFinish()
{
...
//主菜单按钮
	auto backItem = MenuItemImage::create(
		"m11.png",
		"m12.png",
		CC_CALLBACK_1(GameOver1::backBtnMenu, this)
	...
	auto againItem = MenuItemImage::create(
		"r11.png",
		"r12.png",
		CC_CALLBACK_1(GameOver1::againBtnMenu, this)
...
// 返回至施文强界面
void GameOver1::backBtnMenu(Ref *ref){
...
void GameOver1::againBtnMenu(Ref *ref){
