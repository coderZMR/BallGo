...
void GameOver2::onEnterTransitionDidFinish()
{
...
bool GameOver2::init(){
	...
	auto backItem = MenuItemImage::create(
		"m21.png",
		"m22.png",
		CC_CALLBACK_1(GameOver2::backBtnMenu, this)
	...
	auto againItem = MenuItemImage::create(
		"r21.png",
		"r22.png",
		CC_CALLBACK_1(GameOver2::againBtnMenu, this)
...
// 返回至施文强界面
void GameOver2::backBtnMenu(Ref *ref){
...
void GameOver2::againBtnMenu(Ref *ref){
