...
void GameOver3::onEnterTransitionDidFinish()
{
...
bool GameOver3::init(){
	...
	auto backItem = MenuItemImage::create(
		"m31.png",
		"m32.png",
		CC_CALLBACK_1(GameOver3::backBtnMenu, this)
	...
	auto againItem = MenuItemImage::create(
		"r31.png",
		"r32.png",
		CC_CALLBACK_1(GameOver3::againBtnMenu, this)
...
// 返回至施文强界面
void GameOver3::backBtnMenu(Ref *ref){
...
void GameOver3::againBtnMenu(Ref *ref){
